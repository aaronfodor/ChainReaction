...
class GameActivity : AdActivity(), IGameView, View.OnClickListener {
    ...
    /**
     * Creates the hu.bme.aut.android.chain_reaction.presenter with an intent of a NxM dimensional Playground, and sets the onClickListeners on the Fields
     */
    ...
    /**
     * Stops the hu.bme.aut.android.chain_reaction.presenter calculations of the activity
     */
    override fun finish() {
        super.finish()
        this.presenter.stop()
